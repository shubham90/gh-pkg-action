...
function installCredProviderToUserProfile(overwrite) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield copyCredProviderFiles(netCoreSource, netCoreDest, overwrite);
        console.log();
        ...
        if (isWin) {
            ...
            yield copyCredProviderFiles(netFxSource, netFxDest, overwrite);
            console.log();
        }
    });
}
exports.installCredProviderToUserProfile = installCredProviderToUserProfile;
function copyCredProviderFiles(source, dest, overwrite) {
    return __awaiter(this, void 0, void 0, function* () {
        // File copy is potentially unreliable, so retry up to 3 times
        if ((yield fse.pathExists(dest)) && !overwrite) {
            console.log(`Skipping copying from '${source}' to '${dest}' because the destination already exists and overwrite is disabled`);
            return;
        }
        if (overwrite) {
...
function configureCredProvider(protocol) {
    return __awaiter(this, void 0, void 0, function* () {
        yield configureCredProviderForSameOrganizationFeeds(protocol);
    });
}
exports.configureCredProvider = configureCredProvider;
function configureCredProviderForSameOrganizationFeeds(protocol) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const identityDisplayName = connectionData.authenticatedUser.customDisplayName ||
...
exports.configureCredProviderForSameOrganizationFeeds = configureCredProviderForSameOrganizationFeeds;
