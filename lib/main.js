...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            var archiveSource = downloadArchive("https://vstsagenttools.blob.core.windows.net/tools/NuGetCredProvider/0.1.20/c.zip");
            // copy the files
            ...
            yield credentialProviderUtils_1.installCredProviderToUserProfile();
